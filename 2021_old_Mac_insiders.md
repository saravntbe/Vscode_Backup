...
- [dahong.theme-bear](https://marketplace.visualstudio.com/items?itemName=dahong.theme-bear)
- [daylerees.rainglow](https://marketplace.visualstudio.com/items?itemName=daylerees.rainglow)
- [dbaeumer.vscode-eslint](https://marketplace.visualstudio.com/items?itemName=dbaeumer.vscode-eslint)
- [dhedgecock.radical-vscode](https://marketplace.visualstudio.com/items?itemName=dhedgecock.radical-vscode)
- [dqisme.sync-scroll](https://marketplace.visualstudio.com/items?itemName=dqisme.sync-scroll)
...
- [GulajavaMinistudio.mayukaithemevsc](https://marketplace.visualstudio.com/items?itemName=GulajavaMinistudio.mayukaithemevsc)
...
- [Luxcium.pop-n-lock-theme-vscode](https://marketplace.visualstudio.com/items?itemName=Luxcium.pop-n-lock-theme-vscode)
...
- [pshershov.blueberry-banana](https://marketplace.visualstudio.com/items?itemName=pshershov.blueberry-banana)
- [royaction.color-manager](https://marketplace.visualstudio.com/items?itemName=royaction.color-manager)
- [sainnhe.gruvbox-material](https://marketplace.visualstudio.com/items?itemName=sainnhe.gruvbox-material)
